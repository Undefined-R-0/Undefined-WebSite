    ...
    <div class="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-24">
      <div class="mx-auto mb-8 max-w-screen-md text-center lg:mb-12">
        ...
        <p class="mb-5 font-light text-gray-500 sm:text-xl">
          Here at Landwind we focus on markets where technology, innovation, and capital can unlock long-term value and
      ...
      <div class="space-y-8 sm:gap-6 lg:grid lg:grid-cols-3 lg:space-y-0 xl:gap-10">
        <!-- Pricing Card -->
        <div
          class="mx-auto flex max-w-lg flex-col rounded-lg border border-gray-100 bg-white p-6 text-center text-gray-900 shadow xl:p-8"
        >
          ...
          <a
            href="#"
            class="rounded-lg bg-purple-600 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-purple-700 focus:ring-4 focus:ring-purple-200"
            >Get started</a
          >
        </div>
        <!-- Pricing Card -->
