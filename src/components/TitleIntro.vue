<template>
  <div class="mx-auto flex justify-center px-4 pb-10 pt-20 lg:gap-8 lg:py-10 lg:pt-20 xl:gap-0">
    <div class="">
      <h1
        class="mb-4 text-wrap text-6xl font-extrabold leading-none tracking-tight sm:text-6xl md:text-7xl lg:text-8xl xl:text-8xl"
      >
        <span class="jump text-purple-700">U</span> ndefined <br />
        <span class="jump text-purple-700">U</span> nidentified <br />
        <span class="jump text-purple-700">U</span> nknown
      </h1>
      ...
      <div class="space-y-4 sm:flex sm:space-x-4 sm:space-y-0">
        <a
          :href="githubUrl"
          class="inline-flex w-full items-center justify-center rounded-lg border border-gray-200 px-5 py-3 text-center text-sm font-medium text-gray-900 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 sm:w-auto"
        >
          加入我们
        </a>
      </div>
